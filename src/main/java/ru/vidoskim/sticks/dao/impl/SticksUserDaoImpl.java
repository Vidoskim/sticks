package ru.vidoskim.sticks.dao.impl;
...
public class SticksUserDaoImpl extends BaseDaoImpl<SticksUser, Long> implements SticksUserDao {
    ...
    @Override
    public SticksUser save(SticksUser user) throws SQLException {
        createOrUpdate(user);
        return user;
    }

    @Override
    public void saveAll(List<SticksUser> users) throws SQLException {
    ...
    @Override
    public Optional<SticksUser> findById(Long id) throws SQLException {
        SticksUser result = queryForId(id);
        return Optional.ofNullable(result);
    }

    @Override
    public Optional<SticksUser> findByUsername(String username) throws SQLException {
